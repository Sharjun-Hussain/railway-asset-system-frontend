        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50/50 hover:bg-slate-50/50 border-b border-slate-200">
              ...
              <TableHead className="font-semibold text-slate-600 text-sm py-3">Sub-Category Name</TableHead>
              <TableHead className="font-semibold text-slate-600 text-sm py-3">Parent Category</TableHead>
